// Mock data for diamond jewelry showcase
export const products = [
  ...
  {
    id: '7',
    name: 'Buttercup Diamond Bracelet',
    category: 'bracelet',
    subcategory: 'buttercup',
  ...
  {
    id: '9',
    name: 'Fancy Color Diamond Bracelet',
    category: 'bracelet',
    subcategory: 'fancy-color',
  ...
  {
    id: '10',
    name: 'Fancy Design Bracelet',
    category: 'bracelet',
    subcategory: 'fancy-design',
  ...
  {
    id: '15',
    name: 'All the Way Diamond Bangle',
    category: 'bangle',
...
export const brandStory = {
  ...
  subtitle: 'Where tradition meets contemporary refinement',
  description: 'For over three decades, we have dedicated ourselves to sourcing and crafting exceptional diamond jewelry. Each piece represents our commitment to quality, ethical sourcing, and timeless design.',
  values: [
    { title: 'Ethical Sourcing', description: 'Every diamond is responsibly sourced and certified' },
    { title: 'Master Craftsmanship', description: 'Hand-selected by experienced artisans' },
    { title: 'Timeless Design', description: 'Classic pieces that transcend trends' }
  ]
};