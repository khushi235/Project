...
import { X, Plus, Edit2, Trash2, Save, Upload, LogOut, Check } from 'lucide-react';
...
const AdminPanel = ({ onClose, onLogout }) => {
  ...
  const needsSinglePriceColumn = (categoryId) => {
    return ['bracelet', 'pendant', 'earring', 'ring'].includes(categoryId);
  };
                        ...
                        <div className="image-upload-wrapper">
                          ...
                          {productForm.imageUrl && (
                            <div className="image-preview">
                              <img src={normalizeImageUrl(productForm.imageUrl)} alt="Preview" />
                            </div>
                          )}
                        </div>
                      </div>
